...
public class Main
{
    ...
    private static String dataFile = "C:\\Temp\\map.json";
    private static Scanner scanner;

    private static StationIndex stationIndex;
//    private static Logger logger;
//    private static Logger loggerSearch = LogManager.getLogger("SEARCH");
//    private static Logger loggerInput = LogManager.getLogger("INPUT_ERRORS");
//    private static Logger loggerExceptions = LogManager.getLogger("EXCEPTIONS");
    ...
    private static final Marker EXCEPTION_STATIONS_MARKER = MarkerManager.getMarker("EXCEPTION_STATION");
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            ...
            {
                LOGGER.error(EXCEPTION_STATIONS_MARKER, ex.getMessage());
            }
        }
    }
